...
exports.handler = async (event) => {
  ...
  console.log(`\n=== [Lambda] DELETE /groups/{grupo_id}/tipos-instrumentos/{id} | ${TRACE_ID} ===`);
  ...
  try {
    ...
    console.log(`[${TRACE_ID}] ✅ Tipo de instrumento eliminado: ${tipoId}`);
    ...
    console.error(`[${TRACE_ID}] ❌ Error eliminando tipo de instrumento:`, error);
    ...
    return {
      ...
      body: JSON.stringify({ 
        ok: false, 
        error: "Error al eliminar tipo de instrumento",
