...
// PUT /api/grupos/:grupo_id/instrumentos/:id - Actualizar instrumento
router.put('/:grupo_id/instrumentos/:id', async (req, res) => {
  try {
    ...
    const response = await fetch(`${process.env.API_BASE_URL}/groups/${grupo_id}/instrumentos/${id}`, {
      method: 'PUT',
      headers: {
        'Authorization': `Bearer ${req.session.user.idToken}`,
        'Content-Type': 'application/json'
    ...
    console.error('Error en PUT /api/grupos/:grupo_id/instrumentos/:id:', error);
    res.status(500).json({
      ok: false,
...
// DELETE /api/grupos/:grupo_id/instrumentos/:id - Eliminar instrumento
router.delete('/:grupo_id/instrumentos/:id', async (req, res) => {
  try {
    const { grupo_id, id } = req.params;
    ...
    console.error('Error en DELETE /api/grupos/:grupo_id/instrumentos/:id:', error);
    res.status(500).json({
      ok: false,
