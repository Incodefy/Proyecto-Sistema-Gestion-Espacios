...
Write-Host "📤 Subiendo variables de entorno a AWS Parameter Store..." -ForegroundColor Cyan
...
Write-Host "✅ Variables subidas exitosamente a AWS Parameter Store" -ForegroundColor Green
Write-Host "🔍 Verifica con: aws ssm get-parameters-by-path --path '/hospital/$ENV' --region $REGION" -ForegroundColor Yellow
